...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addPerson(Person orang) {
    ...
    public boolean updatePerson(Person orang) {
        SQLiteDatabase db = getWritableDatabase();
    ...
    public int deletePerson(Person id) {
        SQLiteDatabase db = getWritableDatabase();
    ...
    public ArrayList<Person> getAllPerson() {
        ArrayList<Person> orangList = new ArrayList<>();
