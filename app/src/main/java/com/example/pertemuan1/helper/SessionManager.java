package com.example.pertemuan1.helper;
...
public class SessionManager {
    ...
    public void createRegisterSession(String email, String name, String password, String jenis_kelamin) {
        editor.putString(KEY_EMAIL, email);
    ...
    public HashMap<String, String> getRegisterDetails() {
        ...
        user.put(KEY_PASSWORD, pref.getString(KEY_PASSWORD, null));
        user.put(KEY_JENISKELAMIN, pref.getString(KEY_JENISKELAMIN, null));
        return user;
    }
}
